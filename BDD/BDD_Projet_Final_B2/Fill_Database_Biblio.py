...
connectionString = "Server=localhost:5000;User ID=api;Password=azerty;Database=db"
...
def load_data():
    ...
    insert_user(2, "adriana.pullig@biblio.com", hash_passwd("adriana1234"), "", "Adriana Pullig", True)
